  ...
  pages: [
    {
      ...
      infos: [
        ...
        '* My journey as a Web and App developer started when I was a just a kid trying to figure out how video games where made.',
        ...
        items: [
          {
            ...
            websiteURL: 'https://www.aman--sapkota.com.np',
          },
          {
            url: 'websites-preview/snow-hero.png',
            websiteURL: 'https://www.amansapkota.org.np',
          },
          {
            url: 'websites-preview/minecraft-in-js.png',
            websiteURL:
              'https://www.youtube.com/@acircusoflearning3601',
          },
          {
            url: 'websites-preview/fish-chopter.png',
            websiteURL: 'https://www.amansapkota.info.np',
          },
          {
      ...
      imageList: {
        ...
        items: [
          ...
          },
          {
            ...
            websiteURL: 'https://github.com/Amansapkota',
          },
          {
            url: 'icons/email.png',
            websiteURL: 'amansapkotaa@gmail.com',
          },
        ],
      },
    },
